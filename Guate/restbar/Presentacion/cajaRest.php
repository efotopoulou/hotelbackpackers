...
?>
    if(<?php echo($categoria[$i]->id_categoria); ?>==5)  $("#categoria").append("<option <?php echo $admin ?> value='<?php echo($categoria[$i]->id_categoria); ?>'><?php echo($categoria[$i]->nombre); ?></option>");   
