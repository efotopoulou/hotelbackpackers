...
if (json.stockInfo){ 
    ...
    for(i=0;i<json.stockInfo.length;i++) {
     $("#stockTable").append("<tr><td width=10%>"+json.stockInfo[i].numBebida+"</td><td width=10%>"+json.stockInfo[i].familia+"</td><td>"+json.stockInfo[i].nombre+"</h6></td><td width=10%>"+json.stockInfo[i].stockbar+"</td><td width=10%>"+json.stockInfo[i].unidadventa+"</td></tr>");	
    }
 }else{
 $("#stockTable").html(" ");
      }
...
<div>
	...
	<h4>Control de Stock del Restaurante-Bar</h4><br/>
