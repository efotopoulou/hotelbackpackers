...
<?php if($allowedRest["bebida"]){ ?><li><a href="/recepcion/view.php?page=bebida" target="_blank">Bebida</a></li><?php } ?>
<?php if($allowedRest["comida"]){ ?><li><a href="/recepcion/view.php?page=comida" target="_blank">Comida</a></li><?php } ?>
