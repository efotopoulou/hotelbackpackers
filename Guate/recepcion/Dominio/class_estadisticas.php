...
require ($_SERVER['DOCUMENT_ROOT'] . '/recepcion/Datos/Destadisticas.php');
require ('cmweek.php');
require ('cmmonth.php');
require ('cmyear.php');
...
class estadisticas{
		...
		$tpw = new Destadisticas();
		$rs = $tpw->topPlatillosWeek($year,$month,$date,$limit);
		...
		function topPlatillosMonth($year,$month,$limit){
		$tpm = new Destadisticas();
		$rs = $tpm->topPlatillosMonth($year,$month,$limit);
		...
		function topPlatillosYear($year,$limit){
		$tpy = new Destadisticas();
		$rs = $tpy->topPlatillosYear($year,$limit);
