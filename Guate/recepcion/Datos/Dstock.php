...
class Dstock{
	...
	const VENTA_TURNO = 'select t1.idBebida,t5.numBebida,t5.nombre,sum(t4.cantidad)as suma,t6.clientType from stockbebidas t1,caja t2,comanda t3,lineacomanda t4,bebida t5, tipoCliente t6 where t1.stockrestaurante != 0 and t1.idBebida=t4.idPlatillo and t2.estado=1 and t2.id_caja=t3.id_caja and t3.idComanda=t4.idComanda and t1.idBebida=t5.idBebida and t6.idTipoCliente=t3.tipoCliente group by t1.idBebida,t3.tipoCliente';
