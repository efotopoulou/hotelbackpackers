...
class Dreporte{
	...
	const GET_TIQUETS = 'select date(fechaHora) as fecha,time(fechaHora) as time,numComanda as idComanda,total from comanda t1,caja t2 where t1.id_caja=t2.id_caja and t2.id_caja=? and t1.numComanda is not null';
