...
if ((sizeof($pedidos))>0){
	  ...
	  $PedidosInfo[$i]=array("idLineaComanda"=>$pedidos[$i]->idLineaComanda,"idComanda"=>$pedidos[$i]->idComanda,"idPlatillo"=>$pedidos[$i]->idPlatillo,"nombre"=>$pedidos[$i]->nombre,"cantidad"=>$pedidos[$i]->cantidad,"hora"=>$pedidos[$i]->hora);
	  }
 }	
