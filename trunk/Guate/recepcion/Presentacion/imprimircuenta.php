...
if (json.TicketsInfo){
     ...
     for(i=0;i<json.TicketsInfo.length;i++) {
      ...
      for(i=0;i<json.MovimientosInfo.length;i++) {
        $("#movimientosTable").append("<tr><td width=18%>"+json.MovimientosInfo[i].fechaHora+"</td><td width=8%>"+json.MovimientosInfo[i].tipo+"</td><td width=10%>"+json.MovimientosInfo[i].dinero+"</td><td>"+json.MovimientosInfo[i].descripcion+"</td><td>"+json.MovimientosInfo[i].categoria+"</td><td width=10%>"+json.MovimientosInfo[i].encargado+"</td></tr>");          	
        }
        }else{
        $("#movimientosTable").html(" ");
        }
...
<div>
    ...
    <table id="ticketsTable" width=80% border=1></table>
    <br/><br/>
    
    <div id="comandas"><h4>Movimientos a Credito realizados<br/></h4></div>
    <table width=100% border=1>
    <tr><td width=25%><h4><center>Fecha Hora</center></h4></td><td width=9%><h4><center>estado</center></h4></td><td width=6%><h4>Total</h4></td><td width=10%><h4>Cliente</h4></td><td><h4><center>Nombre de Cliente</center></h4></td></tr>
    </table>
    <table id="movimientosTable" width=100% border=1></table>
