...
class Dcocina{
	...
	const SELECT_PEDIDOS = 'select t1.idLineaComanda,t4.idComanda,t2.idPlatillo,t3.nombre,t2.cantidad,time(t4.fechaHora) as hora from cocina t1,lineacomanda t2,platillo t3,comanda t4 where t4.idComanda=t2.idComanda and t1.idLineaComanda=t2.idLineaComanda and t3.idPlatillo=t2.idPlatillo and t1.presentado=1 order by t4.fechaHora asc';
	...
	const RECUPERAR_LINEAID = 'select t1.idLineaComanda from cocina t1,lineacomanda t2,platillo t3,comanda t4 where t4.idComanda=t2.idComanda and t1.idLineaComanda=t2.idLineaComanda and t3.idPlatillo=t2.idPlatillo order by t1.horadelete desc limit 1';
